# Generated by Django 4.0.6 on 2022-07-21 21:30
...
def populate(apps, schema_editor):
    ...
    question_fields = [
		...
		["payment_amount", "(award)", "After all deductions, have you been receiving the wage that Your answers suggest that you may be entitled to by the relevant terms of your award?", "After all deductions, were you receiving the wage that you were entitled to by the relevant terms of your award?"],
		["payment_amount", "(agreement)", "After all deductions, have you been receiving the wage that Your answers suggest that you may be entitled to by the relevant terms of your enterprise agreement?", "After all deductions, were you receiving the wage that you were entitled to by the relevant terms of your enterprise agreement?"],
		["payment_amount", "(over_minimum)", "After all deductions, have you been receiving the wage that Your answers suggest that you may be entitled to by the relevant terms of your employment contract?", "After all deductions, were you receiving the wage that you were entitled to by the relevant terms of your employment contract?"],
    ...
    choice_fields = [
		...
		["PL_adopt_start", "(not_before)", "No.", "No.", "(after_placement)"],
		["PL_adopt_start", "(couple)", "Yes.", "Yes.", "(after)"],
		["PL_adopt_start", "(couple)", "No.", "No.", "(not_after)"],
		["PL_adopt_start", "(after)", "Yes.", "Yes.", "(after_placement_couple)"],
		["PL_adopt_start", "(after)", "No.", "No.", "(not_after)"],
    ...
    dependency_fields = [
		...
		["notice", "(resigned)", "(giving_award)", "award", "apply"],
		["notice", "(resigned)", "(giving_award)", "award", "award_agreement_TCF"],
		["notice", "(resigned)", "(giving_agreement)", "award", "award_agreement"],
		["notice", "(resigned)", "(giving_agreement)", "award", "agreement"],
		["notice", "(resigned)", "(giving_agreement)", "award", "high_agreement"],
    ...
    comment_fields = [
		...
		["PL_adopt_start", "(sole)", "Your period of UPL starts at the date of placement of the child. \n\nWe continue on that basis.", "Your period of UPL starts at the date of placement of the child. \n\nWe continue on that basis.", "(from)"],
		...
		["PL_adopt_start", "(after_placement)", "Your period of UPL starts immediately after the end of your partner’s period of UPL. We continue on that basis.", "Your period of UPL starts immediately after the end of your partner’s period of UPL. We continue on that basis.", "(after_placement1)"],
    ...
    reference_fields = [
		...
		["PL_adopt_start", "(from)", "from_placement_first"],
		...
		["PL_adopt_start", "(not_after)", "from_placement"],
    ...
    law_fields = [
		...
		["notice", "giving_award", "notice.giving_award", "notice.giving_award"],
		["notice", "giving_agreement", "notice.giving_agreement", "notice.giving_agreement"],
		...
		["undue_influence", "other", "undue_influence.other", "undue_influence.other"],
